...
import CheckedHalf from './svg/checked_half.svg';
import Checkin from './svg/checkin.svg';
import CheckinFilled from './svg/checkin_filled.svg';
...
import OffPeak from './svg/off-peak.svg';
