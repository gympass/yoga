...
metaDescription: 'Making our decisions available to all components'
order: 1
---
...
ThemeProvider accepts a property for theming with use of our <GatsbyLink to='/components/theming/themeGenerator'>theme generator</GatsbyLink>.
