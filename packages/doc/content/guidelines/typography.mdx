...
| `<Text.Overline>`          | xsmall (12)   | bold (700)      | bold (700)           | xsmall (16)     | Overline texts are used sparingly to present a title (above titles), list a component attribute and inside small data visualization components.  |
